...
!function (a, b, c, d) {
    ...
    e.prototype.setup = function () {
        ...
        c ? (a.each(c, function (a) {
            a <= b && a > d && (d = Number(a))
        }), e = a.extend({}, this.options, c[d]), "function" == typeof e.stagePadding && (e.stagePadding = e.stagePadding()), delete e.responsivee, e.responsiveeClass && this.$element.attr("class", this.$element.attr("class").replace(new RegExp("(" + this.options.responsiveeClass + "-)\\S+\\s", "g"), "$1" + d))) : e = a.extend({}, this.options),
        this.trigger("change", {
            property: {
                name: "settings",
                value: e
    ...
    e.prototype.onThrottledResize = function () {
        ...
        this.resizeTimer = b.setTimeout(this._handlers.onResize, this.settings.responsiveeRefreshRate)
    },
    ...
    e.prototype.registerEventHandlers = function () {
        ...
        !1 !== this.settings.responsivee && this.on(b, "resize", this._handlers.onThrottledResize),
    ...
    e.prototype.viewport = function () {
        var d;
        return this.options.responsiveeBaseElement !== b ? d = a(this.options.responsiveeBaseElement).width() : b.innerWidth ? d = b.innerWidth : c.documentElement && c.documentElement.clientWidth ? d = c.documentElement.clientWidth : console.warn("Can not detect viewport width."),
        d
    },
    ...
    e.prototype.destroy = function () {
        ...
        a(c).off(".owl.core"),
        !1 !== this.settings.responsivee && (b.clearTimeout(this.resizeTimer), this.off(b, "resize", this._handlers.onThrottledResize));
